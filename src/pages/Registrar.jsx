...
// Função para carregar cidades ao selecionar um estado
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-color-grad relative">
            ...
            <div className="bg-white shadow-lg rounded-lg p-8 mb-4 w-full max-w-screen-lg relative z-10">
                <div id="cabecalho" className="flex items-center mb-6">
                    <img className="w-10 h-10 mr-2" src={iconeCadastro} alt="Ícone de Registrar" />
                    <h1 className="text-6xl font-bold">Registrar</h1>
                </div>
                <form id="area_cadastro" onSubmit={handleRegister}>
                    <h2 className="text-2xl font-bold mb-2 pt-8 pb-2">SOBRE VOCÊ</h2>
                    <input className="border-[1px] border-black shadow-md h-14 focus:outline-none focus- focus:shadow-lg focus:shadow-gray-300/50 transition-shadow duration-200 rounded-lg p-2 w-full  mb-4"
                        type="text"
                        maxLength='14'
                        value={nome}
                    ...
                    <div className="flex justify-between mb-4 gap-12">
                        <input
                            ...
                            placeholder="CPF"
                            className="border-[1px] border-black shadow-md h-14 focus:outline-none focus- focus:shadow-lg focus:shadow-gray-300/50 transition-shadow duration-200 rounded-lg p-2 w-1/2 mr-2"
                            required
                        />
                        <input
                            type="date"
                            ...
                            className="border-[1px] border-black shadow-md h-14 focus:outline-none focus- focus:shadow-lg focus:shadow-gray-300/50 transition-shadow duration-200 rounded-lg p-2 w-1/2 ml-2"
                            required
                        />
                        
                    </div>
                    <h2 className="text-2xl font-bold mb-2 pt-4 pb-2">INFROAMÇÕES DE CONTATO</h2>
                    <div className="flex justify-between mb-4 gap-12">
                        <input
                            type="email"
                            value={email}
                    ...
                    <h2 className="text-2xl font-bold mb-2 pt-4 pb-2">ENDEREÇO</h2>
                    <div className="flex justify-between mb-4 gap-12">
                        <select
                            value={estado}
                    ...
                    <h2 className="text-2xl font-bold mb-2 pt-4 pb-2">CRIE SUA SENHA</h2>
                    <div className="flex justify-between mb-4 gap-12">
                        <div className="relative w-1/2 mr-2">
                            <input
                                ...
                                placeholder="Senha"
                                className="border-[1px] border-black shadow-md h-14 focus:outline-none focus:shadow-lg focus:shadow-gray-300/50 transition-shadow duration-200 rounded-lg p-2 w-full pr-10"
                                required
                            />
                            <div
                        ...
                        <div className="relative w-1/2 ml-2">
                            <input
                                ...
                                className="border-[1px] border-black shadow-md h-14 focus:outline-none focus:shadow-lg focus:shadow-gray-300/50 transition-shadow duration-200 rounded-lg p-2 w-full pr-10" // Ajusta o padding à direita para o ícone
                                required
                            />
                            <div
                                className="absolute right-3 top-1/2 transform -translate-y-1/2 cursor-pointer"
                                onClick={isVisibleRePassword}
                            >
                                {mostrarConfirmarSenha ? <FaEyeSlash /> : <FaEye />}
                            </div>
                        </div>
                    </div>
                    <span className="block mb-2 pt-4 pb-4" >A senha deve conter entre 8 a 16 caracteres:</span>
                    ...
                    <div className="flex items-center mb-4">
                        <input
                            ...
                            required
                        />
                        <span>Li e aceitos os termos de condição da empresa.</span>
                    </div>
                    {mensagemErro && (
                    ...
                    <div className="flex justify-center mt-4 pt-2">
                        <button
                            type="submit"
                            className="bg-purple-500 text-white rounded-lg px-4 py-2 h-12 transition hover:bg-purple-600"
                            disabled={isLoading}
                        >
                            {isLoading && (
